...
// import FeaturedProject from '../homepage/components/featuredProject';
...
//         <InviteComponent isProjectPage={true}/>
//         <FeaturedProject showAll/>
//         <FooterComponent/>
...
export default function PortfolioPage() {
  ...
  const nextImage = () => {
    ...
    if (selectedImage === portfolioProjects.length - 1)
      setSelectedImage(0);
    else
  ...
  const previousImage = () => {
    ...
    if (selectedImage === 0)
      setSelectedImage(portfolioProjects.length - 1);
    else
      setSelectedImage(selectedImage - 1);
  };
  ...
  const collectionPageSchema = {
    ...
    name: "Architecture Portfolio – Roots & Roof Designers Inc.",
    description:
      "A curated portfolio showcasing biophilic, sustainable, and regenerative architecture projects.",
    url: "https://www.rootsnroof.com/portfolio",
  };
  ...
  return (
    <>
      <Helmet>
        <title>Architecture Portfolio | Roots & Roof</title>

        <meta
          name="description"
          content="Luxury residences, biophilic homes and sustainable architecture projects by Roots & Roof Designers."
        />
      ...
      <main className="bg-[#F8F6F2] lg:pt-10">

        <NavBar />

        <InviteComponent isProjectPage />
        ...
        {selectedImage !== null && (
          <div className="fixed inset-0 z-[999] bg-black/95 flex items-center justify-center">
            ...
            <button
              ...
              className="absolute top-8 right-8 text-white text-5xl hover:text-gray-300 transition"
            >
              ×
            </button>
            ...
            <button
              ...
              className="absolute left-5 md:left-10 text-white text-6xl"
            >
              ‹
            </button>
            ...
            <img
              src={portfolioProjects[selectedImage].image}
              alt={portfolioProjects[selectedImage].title}
              className="
                max-w-[92vw]
                max-h-[88vh]
                object-contain
            ...
            <div className="absolute bottom-10 text-center text-white">
              ...
              <p className="uppercase tracking-[0.25em] text-sm text-gray-300">

                {portfolioProjects[selectedImage].location}

              </p>

              <h2 className="mt-2 text-3xl font-light">

                {portfolioProjects[selectedImage].title}
            ...
            <button
              onClick={nextImage}
              className="absolute right-5 md:right-10 text-white text-6xl"
            >
              ›
            </button>
